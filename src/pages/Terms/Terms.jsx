        ...
        <ScrollReveal>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-light-text leading-relaxed">
              Welcome to the Praxis Journal of Society, Behaviour and Institutional Studies. By accessing and using this website, you are requested to read these rules carefully. These Terms & Conditions outline the rules and regulations for the use of our publication platform.
            </p>
          </div>
        </ScrollReveal>
