        ...
        <ScrollReveal>
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            <p className="text-light-text leading-relaxed">
              We are deeply committed to protecting your privacy and ensuring the security of your personal data. This Privacy Policy outlines how we collect, use, maintain, and disclose information collected from users (authors, reviewers, and readers) of our Praxis Journal of Society, Behaviour and Institutional Studies.
            </p>
          </div>
        </ScrollReveal>
